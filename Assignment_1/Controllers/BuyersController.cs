...
namespace Assignment_1.Controllers
{
    ...
    public class BuyersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Email")] Buyer buyer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Email")] Buyer buyer)
        {
            if (id != buyer.Id)
            {
                return NotFound();
